...
from fw_fanctrl_gui.ServiceCachedStatus import ServiceCachedStatus
...
class MainWindow(MainWindow_UI):
    ...
    def __init__(self, master = None, fanctrl_service = None):
        ...
        self.service_section = ServiceSection(self, self.master, self.builder, self.fanctrl_service,
    ...
    def update_status_event(self, service_status: ServiceStatus):
        if service_status.reachable != service_status.previously_reachable or service_status.previous_status is None:
